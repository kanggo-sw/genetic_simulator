...
def draw():
    ...
    text('Foods %d' % manager.alive_foods, 20, 90)
    text('Avg. Speed %.2f' % manager.avg_speed, 20, 120)
    text('Avg. Sensing Dist %.2f' % manager.avg_sensing_dist, 20, 150)
